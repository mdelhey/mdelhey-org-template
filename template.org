...
#+LATEX_HEADER: \usepackage[innermargin=1.0in,outermargin=1.0in,vmargin=3cm]{geometry}
...
# --- Minimal Title ---
#+LATEX_HEADER: \makeatletter\renewcommand{\maketitle}{\bgroup\setlength{\parindent}{0pt}\begin{flushleft}\textbf{\@title}\linebreak\textit{\@author}\end{flushleft}\egroup}\makeatother
